...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1f4f4b1eb8396519025dc523ae687fe8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mwweissmann/ocaml-mosquitto/";
          bugreports = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["mosquitto_stubs.c"];
                      bs_data_files = [];
                      ...
                      bs_cclib =
                        [(OASISExpr.EBool true, ["${mosquitto_libs}"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for mosquitto";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tools";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mosquitto"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "subscribe.ml"});
               Executable
                 ({
                     cs_name = "publish";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "publish.ml"})
            ];
          disable_oasis_section = [];
          conf_type = (`Configure, "custom", Some "0.0.1");
          conf_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command = [(OASISExpr.EBool true, None)]
     ...
     oasis_digest = Some "\155\006\202\171S\1788(\136\011\128\206r\254-U";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
